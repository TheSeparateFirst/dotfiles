...
(put 'c 'custom-loads '("cc-vars" "cc-guess" cmacexp cpp hideif "c"))
...
(defvar custom-versions-load-alist '(("20.3.3" "dos-vars") ("21.2" mm-util) ("20.4" hilit-chg crisp sh-script compile) ("19.29" time-stamp) ("20.8" sql) ("21.3" sql gnus-agent ange-ftp) ("22" ps-print ebnf2ps) ("22.3" message) ("20.1" time-stamp) ("20.3" xscheme etags browse-url dabbrev sendmail vcursor uce msb compile hexl which-func avoid find-func paren add-log debug ffap rmail cus-edit diary-lib vc) ("23.3" diary-lib rmail python desktop rmailsum calendar) ("20" ebnf2ps ps-print) ("23.2" bytecomp comint rmailmm rmail diary-lib desktop lunar mm-encode elint doc-view gnus-sum calendar gnus-group help-fns dired ansi-color auth-source tramp-gvfs message gdb-mi) ("22.2" gnus-sum bibtex-style mail-source sql dired gdb-mi find-dired tls desktop css-mode vc-mtn vc-hg) ("21.1" strokes dabbrev ezimage sgml-mode cal-hebrew sendmail ange-ftp gnus-group gnus-start vc-cvs debug vc-rcs net-utils vc-sccs smtpmail vc server browse-url message paren wid-edit fortran rmailedit find-func ps-print hideshow sb-image gnus-sum rmail cperl-mode latin1-disp gnus-art gnus-agent nnmail add-log flyspell etags cus-edit) ("22.1" uudecode calendar comint dabbrev add-log tcl latin1-disp imap gnus-delay mml2015 ange-ftp gnus-srvr hi-lock view mail-source descr-text fortran allout ielm smime mail-extr rmail gnus-util shadowfile cal-dst gnus-score hl-line sh-script bookmark glasses cus-edit gnus-int locate diary-lib ispell vc-svn gnus-msg landmark diff-mode mm-view cal-tex gnus-start gnus-fun vc-cvs find-func gnus-cite starttls flow-fill mm-uu make-mode generic-x info deuglify keypad sendmail spam desktop mm-url sql autorevert pop3 gnus-spec ffap grep mml gnus time sgml-mode gnus-win mml-sec tex-mode iswitchb gnus-art compile imenu warnings dired gdb-mi server gnus-sum vc tls binhex gnus-group mm-decode message compare-w nnmail mm-util gnus-agent) ("23.1" f90 gnus-dired informat smiley gnus-msg fortran bibtex vc-cvs mml spam-report rmailmm woman server "misearch" vc-git gnus-util vc-mtn hideif info ffap allout smime filesets gnus-score gnus copyright dired-aux fortune nnmail browse-url icomplete compile vc-hg cus-edit checkdoc vc-arch view gnus-bookmark newcomment tex-mode rmail mm-uu gdb-mi face-remap sendmail net-utils nnmairix pcmpl-unix gnus-draft tls calendar time holidays pop3 gnus-art descr-text gnus-sum mm-decode imap gnus-group message) ("24.1" em-smart vc-sccs mm-view gnus-msg server esh-ext shr em-rebind rmail esh-mode url-cache pcmpl-unix vc-svn em-unix gnus-srvr woman smiley esh-io em-cmpl copyright em-ls dired-x js esh-var saveplace em-dirs image-mode em-script vc-git auth-source flyspell calendar em-pred mm-decode mml2015 mml vc-hg gnus log-edit package-x diary-lib gnus-group pop3 cus-edit gnus-art url-queue browse-url hl-line em-hist compile esh-proc esh-arg ange-ftp vc gnus-gravatar em-term ido feedmail gnus-util comint gnus-start etags appt esh-cmd emacs-lock em-prompt em-banner glasses esh-util em-glob vc-cvs ibuffer shell gnus-html python smtpmail sendmail find-dired sql message em-alias package rcirc gnus-sum vc-rcs info rst f90))
